...
function sectorMoveOption(d) {
  ...
  return {
    ...
    legend: {
      ...
      itemGap: 12, itemWidth: 14, itemHeight: 10,
      textStyle: { color: AXIS_TEXT, fontSize: 11 },
      data: ['上证成交额', '上证指数', '上涨推动', '下跌拖累'],
      icon: 'roundRect',
    },
    grid: { left: 52, right: 52, top: 42, bottom: 42 },
    xAxis: {
    ...
    series: [
      { name: '上证成交额', type: 'bar', yAxisIndex: 0, data: barData, barWidth: '62%',
      ...
      { name: '上涨推动', type: 'scatter', yAxisIndex: 1, data: upMoves,
        ...
        z: 10 },
      { name: '下跌拖累', type: 'scatter', yAxisIndex: 1, data: downMoves,
